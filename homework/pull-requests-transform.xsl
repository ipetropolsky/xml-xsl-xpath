...
<xsl:stylesheet version="1.0"
    ...
    <xsl:template match="pullRequest">
        <div class="list-item">
            <div class="list-item_base-info">
                ...
                <div class="list-item_right-part">
                    <div class="list-item_comments">
                        ...
                        <div class="list-item_comments-content">
            ...
            <div class="list-item_additional-info">
                ...
                <div class="pr-author">
                    by <xsl:value-of select="./user/login"/>
                </div>
            </div>
        </div>
    </xsl:template>
    ...
    <xsl:template match="pullRequestsList">
        <div class="statistics">
            <div class="statistics-item">
                ...
                <div class="statistics-item_content">
                    <xsl:value-of select="count(/pullRequestsList/pullRequest[@state='open'])"/> Open
                </div>
            </div>
            <div class="statistics-item">
                <div class="statistics-item_icon">
                ...
                <div class="statistics-item_content">
                    <xsl:value-of select="count(/pullRequestsList/pullRequest[@state='closed'])"/> Closed
                </div>
            </div>
        </div>
    </xsl:template>
    ...
    <xsl:template match="checks[check/status = 'failed']">
